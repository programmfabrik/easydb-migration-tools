...
#         pg_to_source(
#             name="stadt-mannheim",
#             dsn="dbname=stadt-mannheim user=postgres port=5440 host=galaxy",
...
#         # sqlite_to_source(
#         #     name="stadt-mannheim",
#         #     filename="/var/lib/sqlite/stadt-mannheim.sqlite"
#         # )

#         # eas_to_source(
#         #     name="stadt-mannheim",
#         #     url="http://easdb.4.0.mad.pf-berlin.de/eas",
#         #     instance="stadt-mannheim",
#         #     eas_versions= {
#         #         "thumbnail": ["url"]
#         #         }
#         # )
...
#             )
    ...
    # elif 12 == todo:
    # # execute like: datenpumpe.py 30 11 12
    # # ... for prod server. For dev-server:
    # # execute like: datenpumpe.py 31 11 12
    #     # VIKUS projekt, #28010
    #     # IN_INV = "IN (SELECT lk_inventar_id FROM bestandskatalog__inventar)"
    #     # VIKUS projekt, #32637
    #     IN_INV = """
    #     	IN (
    #     		SELECT distinct(i.id) FROM inventar i WHERE lk_sammlung_id IN(
    #     			SELECT id FROM sammlung
    #     			WHERE name = 'SPSG, Porzellan ' OR name = 'SPSG, Porzellan (Europa)' OR name = 'SPSG, Porzellan (Ostasien)'
    #     		)
    #     		AND
    #     			i.id IN (SELECT distinct(lk_inventar_id) from inventar__zeit_ort_einordnung
    #     				WHERE lk_ort_id IN (
    #     					SELECT id FROM dnb_normdaten WHERE
    #     					lower("001")=lower('China') OR
    #     					lower("800c")=lower('China') OR
    #     					lower("800g")=lower('China') OR
    #     					lower("800k")=lower('China') OR
    #     					lower("800p")=lower('China') OR
    #     					lower("800s")=lower('China') OR
    #     					lower("800t")=lower('China') OR
    #     					lower("001")=lower('Japan') OR
    #     					lower("800c")=lower('Japan') OR
    #     					lower("800g")=lower('Japan') OR
    #     					lower("800k")=lower('Japan') OR
    #     					lower("800p")=lower('Japan') OR
    #     					lower("800s")=lower('Japan') OR
    #     					lower("800t")=lower('Japan')
    #     				)
    #     			)
    #     	)
    ...
    #         dsn=spsg_dsn,
    #         # limit=10,
    #         include_schema_in_table_name=False,
    #         include_tables= {
    #             "inventar": {
    #                 "where": "(id "+IN_INV+" OR id IN (SELECT inventar_to_id FROM inventar__foto WHERE inventar_from_id "+IN_INV+"))", #  AND bild > 0",
    #                 "include_columns": {
    #                     "id": True,
    #                     "bild": True,
    #                     "inventar_nr": True,
    #                     "inventarbeschreibung": True,
    #                     "redaktioneller_text": True,
    #                     "redaktioneller_text_autor": True,
    #     					"lk_objektbezeichnung_id": True
    #                     }
    #                 },
    #             "inventar__person": {
    #                 "where": "lk_inventar_id "+IN_INV,
    #                 "include_columns": {
    #                     "id": True,
    #                     "lk_inventar_id": True,
    #                     "lk_inventarpersonfunktion_id": True,
    #                     "lk_person_id": True,
    #                     "objektteil": True
    #                     }
    #                 },
    #             "attribute": {
    #                 "where": " id IN (SELECT lk_inventarmaterial_id FROM inventar__material WHERE lk_inventar_id "+IN_INV+") OR id IN (SELECT lk_inventarmasstyp_id FROM inventar__mass WHERE lk_inventar_id "+IN_INV+") OR id IN (SELECT lk_inventarpersonfunktion_id FROM inventar__person WHERE lk_inventar_id "+IN_INV+") OR id IN (SELECT lk_inventartechnik_id FROM inventar__material__technik WHERE lk_inventar__material_id IN (SELECT lk_inventar_id FROM inventar__material)) OR id IN (SELECT lk_dimension_id FROM inventar__mass__dimension WHERE lk_inventar__mass_id IN (SELECT id FROM inventar__mass WHERE lk_inventar_id "+IN_INV+"))  ",
    #                 "include_columns": {
    #                     "id": True,
    #                     "name": True,
    #                     "lk_sammlung_id": True,
    ...
    #                 },
    #             "dnb_normdaten": {
    #                 "where": " id IN (SELECT lk_person_id FROM inventar__person WHERE lk_inventar_id "+IN_INV+") OR id IN (SELECT lk_ort_id FROM inventar__zeit_ort_einordnung WHERE lk_inventar_id "+IN_INV+") OR id IN (SELECT lk_dnb_normdaten_id FROM inventar__schlagwort WHERE lk_inventar_id "+IN_INV+") OR id IN (SELECT lk_objektbezeichnung_id FROM inventar WHERE id "+IN_INV+")"
    #                 },
    #             "inventar__material": {
    #                 "where": "lk_inventar_id "+IN_INV
    #                 },
    #             "inventar__material__technik": {
    #                 "where": "lk_inventar__material_id IN (SELECT id FROM inventar__material WHERE lk_inventar_id "+IN_INV+")"
    #                 },
    #     			"inventar__titel": {
    #                 "where": "lk_inventar_id "+IN_INV
    #                 },
    #     			"inventar__schlagwort": {
    #                 "where": "lk_inventar_id "+IN_INV
    #                 },
    #     			"inventar__standort": {
    #                 "where": "lk_inventar_id "+IN_INV
    #                 },
    #     			"ort": {
    #                 "where": "id IN (SELECT lk_ort_id FROM inventar__standort WHERE lk_inventar_id "+IN_INV+")"
    #                 },
    #             "inventar__wasserzeichen": {
    #                 "where": "lk_inventar_id "+IN_INV
    #                 },
    #             "inventar__mass": {
    #                 "where": "lk_inventar_id "+IN_INV
    #                 },
    #             "inventar__mass__dimension": {
    #                 "where": "lk_inventar__mass_id IN (SELECT id FROM inventar__mass WHERE lk_inventar_id "+IN_INV+")"
    #                 },
    #             "inventar__bezeichnung": {
    #                 "where": "lk_inventar_id "+IN_INV +" OR lk_foto_id "+IN_INV
    #                 },
    #             "inventar__zeit_ort_einordnung": {
    #                 "where": "lk_inventar_id "+IN_INV
    #                 },
    #             "inventar__bibliothek": {
    #                 "where": "lk_inventar_id "+IN_INV
    #                 },
    #             "inventar__inventar": {
    #                 "where": "(lk_inventar_id_to "+IN_INV+" OR lk_inventar_id_from "+IN_INV+")"
    #                 },
    #             "bibliothek": {
    #                 "where": " id IN (SELECT lk_bibliothek_id FROM inventar__bibliothek WHERE lk_inventar_id "+IN_INV+")",
    #                 "include_columns": {
    #                     "id": True,
    #                     "jahr": True,
    #                     "titel": True
    ...
    #                 },
    #             "inventar__foto": {
    #                 "where": "(inventar_from_id "+IN_INV+" OR inventar_to_id "+IN_INV+")"
    #                 },
    #             "inventar__thementext": {
    #                 "where": "lk_inventar_id "+IN_INV,
    #                 "include_columns": {
    #                     "id": True,
    #                     "lk_inventar_id": True,
    ...
    #                     "kurzname": True,
    #                     "lk_bsk_freigabe": True,
    #                     "name": True,
    #                     "redaktionelle_pruefung": True,
    #                     "sortierfeld": True,
    #                     "steuerfeld_suchmaske": True,
    #                     "thementext_titel": True,
    #                     "thementext_url": True,
    #                     "url": True
    #                     }
    #                 },
    #             "bestandskatalog__inventar": {
    #                 "where": "lk_inventar_id "+IN_INV,
    #                 "include_columns": {
    #                     "id": True,
    #                     "display_name": True,
    #                     "lk_bestandskatalog_id": True,
    #                     "lk_inventar_id": True
    #                     }
    #                 }
    #             }
    ...
    # elif 14 == todo:
    #     prepare_source(
    #         # source=u"/srv/programmfabrik/KundenEasydbs/spsg - SPSG - Stiftung Preussische Schlösser und Gärten Berlin Brandenburg/Vikus-Projekt mit FHP Marian Dörk/Dumps von SPSG/spsg-bestandskatalog-jpeg-url.db",
    #         source=u"/srv/programmfabrik/KundenEasydbs/_tmp/spsg/spsg-vikus-porzellan.db",
    #         # spsg",
    #         init=False,
    #         init_filestore=False
    #         )
    ...
    #     dump_mysql(
    #         output="/srv/programmfabrik/KundenEasydbs/_tmp/spsg/spsg-vikus-porzellan.mysql"
    #         )


    # berlin-partner, by klaus, 2015-05-29, ticket #28304
    # elif 22 == todo:

    #     prepare_source(
    #         source="berlin-partner.360.data.sqlite",
    #         init=True,
    #         init_filestore=True
    #         )
    ...
    #     pg_to_source(
    #         name="berlin-partner",
    #         dsn="dbname=berlin-partner user=postgres host=/var/run/postgresql"
    #         )

    #     sqlite_to_source(
    #         name="berlin-partner",
    #         filename="/opt/easydb/4.0/sql/sqlite/berlin-partner.sqlite"
    #         )

    #     eas_to_source(
    #         name="berlin-partner",
    #         url="http://localhost/eas",
    #         instance="berlin-partner",
    #         eas_versions= {
    #             "360": ["data", "url"],
    #             "huge": ["data", "url"]
    #             }
    ...
    # elif 29 == todo:
    #     # export syrian heritage
    #     prepare_source(
    #         source="syrian.sqlite",
    #         init=True,
    #         init_filestore=True
    #         )
    ...
    #         dsn="dbname=syrian-heritage port=5432 user=postgres",
    #         # include_schema_in_table_name=False
    #         )

    #     sqlite_to_source(
    #         name="syrian-heritage",
    #         filename="/opt/easydb/4.0/sql/sqlite/syrian-heritage.sqlite",
    #         include_tables={
    #             "eadb_columns": True
    #             }
    #         )
    ...
    # execute like: datenpumpe.py 30 11 12
    # elif 30 == todo:
    #     spsg_filename="/opt/easydb/4.0/sql/sqlite/spsg.sqlite"
    #     spsg_output="spsg-vikus-porzellan.mysql"
    #     spsg_dsn="dbname=easydb4-spsg user=postgres port=5432"
    #     # needs the hostname to resolve to an IP (in /etc/hosts) that will result in an allowed(in apache config) access:
    #     spsg_url="http://syrian-heritage.production.easydb.de/eas"

    #     #spsg_url="http://localhost/eas"
    #     #spsg_url="http://easydb.spsg.de/eas"
    #     #spsg_url="http://bestandskataloge.spsg.de/eas"

    ####### SPSG dev #######
    # execute like: datenpumpe.py 31 11 12
    # elif 31 == todo:
    #     spsg_filename="/var/lib/sqlite/spsg.sqlite"
    #     spsg_output="/home/andre/tmp/spsg-vikus-porzellan.mysql"
    #     spsg_dsn="dbname=spsg user=postgres port=5440 host=galaxy"
    #     spsg_url="http://easdb.4.0.mad.pf-berlin.de/eas"

    #     #spsg_dsn="dbname=easydb4-spsg user=postgres"
    #     #spsg_dsn="dbname=spsg-online-zeichnungen-frozen-20120823-1000 user=postgres"
