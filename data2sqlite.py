...
argparser = argparse.ArgumentParser(description='!!! simplified version: only file -K10plus !!! | data2qlite')
...
if args.mode == 'file':
    ...
    if args.K10plus != []:
        for k10plus_file in args.K10plus:
            ...
            logging.info('Adding "' + k10plus_file + '" to Source (start offset:' + str(offset) + ')')
